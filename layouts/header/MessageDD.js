...
import user1 from '@/pages/assets/images/users/user1.jpg';
import user2 from '@/pages/assets/images/users/user2.jpg';
import user3 from '@/pages/assets/images/users/user3.jpg';
import user4 from '@/pages/assets/images/users/user4.jpg';
import user5 from '@/pages/assets/images/users/user5.jpg';
