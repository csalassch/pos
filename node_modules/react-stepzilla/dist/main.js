...
function (_Component) {
  ...
  _createClass(StepZilla, [{
    ...
    value: function getPrevNextBtnLayout(currentStep) {
      ...
      // var nextStepText = "kha"; // first step hide previous btn
      ...
      if (currentStep >= this.props.steps.length-1) {
        //this was commented because on the last step we want to trigger our own button for saving all the data input on previous steps.
        showNextBtn = false;
        // nextStepText=this.props.nextTextOnFinalActionStep;
    ...
    value: function stepMoveAllowed() {
      ...
      if (this.props.dontValidate) {
        ...
        if (skipValidationExecution) {
          ...
          let { wrappedInstance } = this.refs.activeComponent; 
          if(wrappedInstance){ proceed = wrappedInstance.isValidated(); } else { proceed = this.refs.activeComponent.refs.component.isValidated(); }
