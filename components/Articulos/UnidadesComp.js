...
const UnidadesComp = () => {
    ...
    return (
        <Row>
                        ...
                        <div>
                            ...
                            <Modal isOpen={modal} toggle={() => { setModal(false); setisEdited(false); }}>
                                <ModalHeader toggle={() => { setModal(false); }} style={{ color: "#1f4f67" }}>
                                    ...
                                    {isEdited === false ? t('addUnit_headings') : t('editUnits_headings')}
                            ...
                            <Modal isOpen={modalCsv} toggle={() => setModalCsv(false)}>
                                <ModalHeader toggle={() => setModalCsv(false)} style={{ color: "#1186a2" }}><Icon.PlusCircle style={{ marginRight: "5px" }} />{t('loadUnits_heading')}</ModalHeader>
                                <ModalBody className='pb-0'>
            ...
            <Col>
                <TotalRegistries txt={t('units_headings')}/>
                <Transactions />
