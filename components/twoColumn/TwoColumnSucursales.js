            ...
            <div className={`leftPartSub flex-shrink-0 border-end ${isOpen ? 'showLeftPart' : ''}`}>
                ...
                <SimpleBar style={{ height: 'calc(100vh - 200px)' }}>
                    <ListGroup className='pb-4' flush>
                        ...
                        >
                            {/* <i className="bi bi-buildings mx-1" />  */}
                            Dirección
                        </ListGroupItem>
                        {/* <ListGroupItem
                            tag="a"
                        ...
                        <Row>
                            <Col>
                                ...
                                <Row>
                                    <Col>
                                        <FormGroup>
                                            <Label className='labels' style={{ paddingBottom: "0px", marginBottom: "0px", fontWeight: "400" }}>Empresa</Label>
                                            <Select
                                                id="selectInputs2"
                                                label="Single select"
                                                options={
                                                    [{ value: 'Nombre Item 1', label: 'Mat 1' },
                                                    { value: 'Nombre Item 2', label: ' Mat 2' }
                                                    ]}
                                            />
                                        </FormGroup>
                                    </Col>
                                ...
                                <Row>
                                    <Col>
                                        <FormGroup>
                                            <Label className='labels' style={{ paddingBottom: "0px", marginBottom: "0px", fontWeight: "400" }}>Tipo de ubicación</Label>
                                            <Select
                                                id="selectInputs2"
                                                label="Single select"
                                                options={
                                    ...
                                    <Col>
                                        <FormGroup>
                                            <Label className='labels' style={{ paddingBottom: "0px", marginBottom: "0px", fontWeight: "400" }}>Tipo de moneda</Label>
                                            <Select
                                                id="selectInputs4"
                                                label="Single select"
                                                options={
...
TwoColumnSucursales.propTypes = {
    leftContent: PropTypes.node,
    rightContent: PropTypes.node,
};

export default TwoColumnSucursales;