...
const UnidadesComp = () => {
    ...
    const downloadTemplate = () => {
        ...
        a.download = 'Plantilla_Unidades_FreePOS.csv';
                        ...
                        <CardHeader style={{ backgroundColor: "#eef0f2" }}>
                            <Row>
                                <Col>
                                    ...
                                    <h4 style={{ color: "#1186a2" }}>Registro Unidades</h4>
                                </Col>
                                <Col>
                                    <div className='d-flex justify-content-end'>
                                        <Button title='Agregar Unidad' className='btn btn-icon' onClick={() => { setModal(true) }} type="button" style={{ marginRight: "7px" }}><Icon.Plus style={{ marginRight: "0px", verticalAlign: "middle", position: "relative" }} /></Button>
                                ...
                                <Row>
                                    <Col>
                                        ...
                                        <Modal isOpen={modal} toggle={() => {setModal(false);setBtnMessage("Agregar")}}>
                                            <ModalHeader toggle={() => {setModal(false);setBtnMessage("Agregar")}} style={{ color: "#1186a2" }}>{btnMessage==="Agregar"?<Icon.PlusCircle style={{marginRight:"7px"}}/>:(<Icon.Edit2 style={{marginRight:"7px"}}/>)}{btnMessage==="Agregar"?"Agregar Unidad":("Editar Unidad")}</ModalHeader>
                                            <ModalBody>
                                        ...
                                        <Modal isOpen={modalCsv} toggle={() => setModalCsv(false)}>
                                            <ModalHeader toggle={() => setModalCsv(false)} style={{ color: "#1186a2" }}><Icon.PlusCircle /> Cargar Unidades por .CSV</ModalHeader>
                                            <ModalBody>
