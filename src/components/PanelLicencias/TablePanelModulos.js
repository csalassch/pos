...
import { Table, Modal, ModalHeader, ModalBody, ModalFooter, Button, Card, CardHeader, CardBody, Row, Col } from 'reactstrap';
        ...
        <CardHeader>
          <Row>
            <Col>
              ...
              <h4 style={{ color: "#eef0f2" }}>Registro módulo</h4>
            </Col>
            <Col>
              <div className='d-flex justify-content-end'>
                <Button style={{ marginRight: "5px" }} title='Agregar Módulo' onClick={() => { setModal(true); setAction("Agregar") }} className="btn btn-icon" ><Icon.Plus /></Button>
        ...
        <ModalHeader toggle={toggle.bind(null)} style={{ color: "#1186a2", width: "100%" }}>
          <Row>
            <Col>
              ...
              {action === "Editar" ? <div><Icon.Edit3 /> Editar módulo</div> : <div></div>}
            </Col>
            <Col>
              <div className='d-flex justify-content-end'>
